...
namespace ValidaFacturassSAT.CFDI {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CFDI.IConsultaCFDIService")]
    public interface IConsultaCFDIService {
        ...
        ValidaFacturassSAT.CFDI.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<ValidaFacturassSAT.CFDI.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : ValidaFacturassSAT.CFDI.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<ValidaFacturassSAT.CFDI.IConsultaCFDIService>, ValidaFacturassSAT.CFDI.IConsultaCFDIService {
        ...
        public ValidaFacturassSAT.CFDI.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<ValidaFacturassSAT.CFDI.Acuse> ConsultaAsync(string expresionImpresa) {
